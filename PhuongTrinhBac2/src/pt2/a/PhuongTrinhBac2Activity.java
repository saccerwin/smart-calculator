...
public class PhuongTrinhBac2Activity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        final Button but1 = (Button) findViewById(R.id.nhaplai);
        but1.setOnClickListener(new Button.OnClickListener(){

			public void onClick(View arg0) {
				
				String sa1 = ((EditText) findViewById(R.id.a)).getText().toString();
				String sb1 = ((EditText) findViewById(R.id.b)).getText().toString();
				String sc1 = ((EditText) findViewById(R.id.c)).getText().toString();
				sa1="";
				sb1="";
				sc1="";
